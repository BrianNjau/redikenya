...
const AboutUs = () => {
  ...
  const IconWithTextData = [
    {
      ...
      content: "We provide access to a wealth of real-time and historical data, allowing our clients to gain deep insights into market trends, property valuations, demand patterns, RoI market gradient and more.",
    },
    {
      icon: "line-icon-Cursor-Click2 text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e]",
      title: "Informed Decision-Making",
      content: "We equip investors and stakeholders with the tools they need to make decisions grounded in data-driven analysis, mitigating risks and optimizing returns.",
    },
    {
      icon: "line-icon-Archery-2 text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e]",
      title: "Market Transparency",
      content: "Our commitment to transparency ensures that our clients have a clear understanding of market dynamics, property performance, and investment opportunities.",
    },
    {
      icon: "line-icon-Female text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e]",
      title: "Innovation and Technology",
      content: "By harnessing cutting-edge technologies and innovative solutions, we deliver advanced platforms that simplify data analysis, visualization, and interpretation.",
    },
  ]
  ...
  return (
   ...
   {/* Section End */}
          ...
          {/* Section Start */}
          <section id="about" className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
        <Container>
          <Row className="font-serif">
            ...
            <Col lg={4} md={6} className="flex flex-col pr-0">
              <img src="https://images.unsplash.com/photo-1543245924-0b171b1d7303?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80" alt="about us" className="sm:w-full" />
              <div className="bg-white px-[3.5rem] py-[3rem] h-full lg:p-8 sm:p-16">
                <span className="text-darkgray font-medium mb-[10px] block">Our Vision</span>
                <p className="font-sans">We envision a future where every real estate decision is underpinned by
actionable insights derived from comprehensive data analysis. Our commitment lies
in fostering a culture where investors, developers, agents, and stakeholders can
harness the power of data to drive innovation, reduce risk, and seize opportunities.</p>
              </div>
            </Col>
          </Row>
        </Container>
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] xs:py-[50px]">
        <Container>
          <Row className="justify-center flex">
            <div className="text-center mb-20 md:mb-12 col-lg-6 col-sm-8" {...fadeIn}>
              <span className="text-xmd mb-[15px] font-serif block w-full">Value proposition</span>
              <h5 className="font-serif text-darkgray font-medium mb-8 sm:w-full">Key Objectives</h5>
            </div>
